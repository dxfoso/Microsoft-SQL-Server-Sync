...
try {
    if (-not $SkipPrerequisiteTests) {
        ...
        try {
            flutter test test/alameen_operation_boundary_test.dart test/sql_sync_merge_test.dart test/sql_bulk_stage_test.dart test/sql_cmd_output_test.dart test/delta_package_test.dart test/sync_transfer_policy_test.dart
            if ($LASTEXITCODE -ne 0) {
