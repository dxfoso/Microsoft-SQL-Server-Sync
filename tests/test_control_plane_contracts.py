...
class ControlPlaneContractsTests(unittest.TestCase):
    ...
    def test_alameen_lab_inspection_is_targeted_restricted_and_sync_isolated(self):
        ...
        self.assertIn("normalizedAction != 'alameen_lab_invoice_menu_probe'", body)
        self.assertIn("normalizedAction != 'alameen_lab_sales_form_probe'", body)
        ...
        self.assertIn("case alameenLabInvoiceMenuProbeAction:", agent)
        self.assertIn("case alameenLabSalesFormProbeAction:", agent)
        ...
        self.assertIn("UIAutomationClient", laboratory)
        self.assertIn("$menuControls.Add", laboratory)
        self.assertIn("BoundingRectangle", laboratory)
        self.assertIn("buildAlameenSalesFormProbePowerShell", laboratory)
        self.assertIn("Sales-row visual anchor did not match", laboratory)
        self.assertIn("$restorationChangedSamples -gt 1500", laboratory)
        self.assertIn("keybd_event(0x1B", laboratory)
