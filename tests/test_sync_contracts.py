...
class SyncContractsTests(unittest.TestCase):
    ...
    def test_web_workspace_has_dashboard_and_client_log_navigation(self):
        ...
        self.assertIn("DataColumn(label: Text('Last activity'))", clients_page)
        self.assertIn("DataColumn(label: Text('Last result'))", clients_page)
        self.assertIn("DataColumn(label: Text('Totals / scope'))", clients_page)
